...
public final class StrokedCircularProgressViewStrategy: CircularProgressViewStrategy {
...
extension StrokedCircularProgressViewStrategy {
...
extension StrokedCircularProgressViewStrategy {
    ...
    private func addIndeterminateAnimation(to indeterminateLayer: CAShapeLayer) {
        ...
        indeterminateLayer.add(animation, forKey: String(describing: StrokedCircularProgressViewStrategy.self))
    }

    private func removeIndeterminateAnimation(from indeterminateLayer: CAShapeLayer) {
        guard let animation = indeterminateLayer.animation(forKey: String(describing: StrokedCircularProgressViewStrategy.self)) as? CABasicAnimation else {
            return
        }
